...
/// </summary>
public class PartitionLabelSection(PanelCapabilities capabilities)
    : SectionGroup<string>(capabilities)
{
    ...
    public override string DisplayName => "Partition Label";
    public override int MaxItems => Capabilities.MaxPartitions;

    protected override ushort[] GetItemAddress(int item) => [0, (ushort)(100 + item)];
